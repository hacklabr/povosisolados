...
<html>
    ...
    <table cellspacing="0" cellpadding="0" width="600" style="margin: 0 auto;">
      <!-- top header -->
      <tr bgcolor="#9F2032">
        ...
        <td bgcolor="#CCAE6D" colspan="3">
            <table>
                ...
                <?php foreach ($posts as $post) { setup_postdata($post); ?>
                    <td width="270" valign="top" style="padding: 18px 0px 18px 18px;">
                        <a target="_blank" href="<?php echo get_permalink($post); ?>">
                        <img height="200" width="270" src="<?php echo newsletter_get_post_image($post->ID); ?>"></a>
      ...
      <tr>
        <td align="center" bgcolor="#9F2032" colspan="3" style="padding: 10px;">
